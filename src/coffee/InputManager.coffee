...
define [ 'dojo/_base/declare', 'dojo/on', 'dojo/dom-geometry', 'dojo/_base/lang', 'mwe/GameAction' ], (declare, bind, domGeom, lang, GameAction) =>
  declare 'InputManager', null, {
    ...
    bindKeys: ->
      bind document, 'keydown', lang.hitch @, @keyPressed
      bind document, 'keyup', lang.hitch @, @keyReleased
